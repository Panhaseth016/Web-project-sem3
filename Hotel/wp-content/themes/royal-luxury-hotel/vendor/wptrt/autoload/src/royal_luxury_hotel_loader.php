...
class Royal_Luxury_Hotel_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function royal_luxury_hotel_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function royal_luxury_hotel_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function royal_luxury_hotel_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function royal_luxury_hotel_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->royal_luxury_hotel_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function royal_luxury_hotel_load( $class ) {
