...
$banner_title = $hotel_inn_options['banner_title'];
$banner_button_txt = $hotel_inn_options['banner_button_txt'];
$banner_button_url = $hotel_inn_options['banner_button_url'];
$banner_bg_image = $hotel_inn_options['banner_bg_image'];
